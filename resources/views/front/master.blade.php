...
<html lang="en" dir="rtl">
    ...
    <body class="{{$bodyClass ?? ''}}">        <!--upper-bar-->
        <div class="upper-bar">
            <div class="container">
                <div class="row">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route("articale")}}">المقالات</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route("contactUsForm")}}">اتصل بنا</a>
                            </li>
                        </ul>
                        ...
                        <div class="accounts">
                            ...
                            <a href="{{url("login")}}" class="signin">الدخول</a>
                        </div>
